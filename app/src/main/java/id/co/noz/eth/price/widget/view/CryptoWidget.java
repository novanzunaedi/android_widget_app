package id.co.noz.eth.price.widget.view;
...
import id.co.noz.eth.price.widget.api.ApiService;
import id.co.noz.eth.price.widget.app.ETHApp;
...
public class CryptoWidget extends AppWidgetProvider {
    private static final String ACTION_UPDATE_CLICK = "id.co.noz.eth.price.widget.entities.action.UPDATE_CLICK";
    ...
    private void updateAppWidget(Context context, final AppWidgetManager appWidgetManager, final int appWidgetId) {
        ...
        ETHApp.app.getApiComponent().inject(this);
        apiService.getEthereum(Currency.EUR,
            crypto -> {
